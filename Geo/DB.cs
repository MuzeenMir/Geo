...
public class DB
{
    ...
    public DB()
    {
        string connString = "DSN=usersDBSys;User ID=root; Password=password;";//"Driver={MySQL ODBC 9.2 Unicode Driver};Server=localhost;Port=3307;Database=userinfo;Uid=root;Pwd=password";
